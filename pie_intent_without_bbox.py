...
class PIEIntent(object):
    ...
    def pie_convlstm_encdec(self):
        ...
        encoder_vec = RepeatVector(self._encoder_seq_length)(encoder_output) #(none,15,2304)

        decoder_model = self.create_lstm_model(name='decoder_network',
                                               r_state = False,
                                               r_sequence=False)(encoder_vec) #(none,128)
        ...
        self.train_model = Model(inputs=encoder_input,
    ...
    def train(self,
        ...
        self._encoder_seq_length = train_d['encoder_input'].shape[1] #15
